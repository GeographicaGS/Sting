...
var app=app||{};app.model={},app.collection={},app.view={},app.config={API_URL:"http://dev.iepg.es/api",BASE_PATH:"",PAGE_SIZE:16,SEARCH_TIMER:300},app.view.Error=Backbone.View.extend({_template:_.template($("#error_template").html()),initialize:function(){app.events.trigger("menu",""),this.render()},onClose:function(){this.stopListening()},render:function(){return this.$el.html(this._template()),this}}),app.view.NotFound=Backbone.View.extend({_template:_.template($("#notfound_template").html()),initialize:function(){app.events.trigger("menu",""),this.render()},onClose:function(){this.stopListening()},render:function(){return this.$el.html(this._template()),this}}),app.view.Home=Backbone.View.extend({_template:_.template($("#home_template").html()),initialize:function(){this.render()},onClose:function(){this.stopListening()},render:function(){return this.$el.html(this._template()),this}});var app=app||{};app.router=Backbone.Router.extend({langRoutes:{"_link home":{en:"home",es:"inicio"},"_link about":{en:"about",es:"acerca_de"},"_link docs":{en:"documents",es:"documentos"},"_link doc":{en:"document",es:"documento"},"_link contact":{en:"contact",es:"contacto"},"_link news":{en:"news",es:"noticias"},"_link about infr":{en:"structure",es:"estructura"},"_link about meth":{en:"methodologic",es:"metodologia"}},routes:{"":"home",notfound:"notfound",faq:"faq",error:"error",explora:"explora",legal:"legal",privacity:"privacity","*other":"defaultRoute"},initialize:function(){this.route(this.langRoutes["_link home"][app.lang],"home"),this.route(this.langRoutes["_link home"][app.lang]+"/","home"),this.route(this.langRoutes["_link about"][app.lang],"about"),this.route(this.langRoutes["_link docs"][app.lang]+"(/:filter)(/:author)","docs"),this.route(this.langRoutes["_link docs"][app.lang]+"/","docs"),this.route(this.langRoutes["_link doc"][app.lang]+"/:id","doc"),this.route(this.langRoutes["_link contact"][app.lang],"contact"),this.route(this.langRoutes["_link news"][app.lang]+"(/:filter)","news"),this.route(this.langRoutes["_link news"][app.lang]+"/","news"),this.route(this.langRoutes["_link about infr"][app.lang],"aboutInfr"),this.route(this.langRoutes["_link about meth"][app.lang],"aboutMeth")},home:function(){app.showView(new app.view.Home)},about:function(){app.showView(new app.view.About({section:"ppal"}))},aboutInfr:function(){app.showView(new app.view.About({section:"infr"}))},aboutMeth:function(){app.showView(new app.view.About({section:"meth"}))},docs:function(e,t){"null"!=e&&e||(e=null),t||(t=null),app.showView(new app.view.DocsList({filter:e,author:t}))},doc:function(e){app.showView(new app.view.Document({id:e}))},defaultRoute:function(){app.showView(new app.view.NotFound)},notfound:function(){app.showView(new app.view.NotFound)},error:function(){app.showView(new app.view.Error)},contact:function(){app.showView(new app.view.Contact)},news:function(e){"null"!=e&&e||(e=null),app.showView(new app.view.NewsList({filter:e}))},faq:function(){app.showView(new app.view.FAQ)},explora:function(){alert("Funcionalidad en desarrollo")},privacity:function(){app.showView(new app.view.Privacity)},legal:function(){app.showView(new app.view.Legal)}});var ENTER_KEY=13;Backbone.View.prototype.close=function(){this.remove(),this.unbind(),this.onClose&&this.onClose()},String.prototype.endsWith=function(e){return-1!==this.indexOf(e,this.length-e.length)},$(function(){$(document).ajaxError(function(e,t){404==t.status?app.router.navigate("notfound",{trigger:!0}):app.router.navigate("error",{trigger:!0})}),$("body").on("click","a",function(e){var t=$(this).attr("jslink"),n=$(this).attr("href");void 0!=t&&"undefined"!=t&&(e.preventDefault(),"#back"==n&&history.back(),app.router.navigate($(this).attr("href").substring(3),{trigger:!0}))}),app.ini(),$(document).resize(function(){app.resizeMe()}),app.resizeMe()}),app.resizeMe=function(){},app.detectCurrentLanguage=function(){return-1!=document.URL.indexOf("/es/")||document.URL.endsWith("/es")?"es":-1!=document.URL.indexOf("/en/")||document.URL.endsWith("/en")?"en":null},app.ini=function(){this.lang=this.detectCurrentLanguage(),this.router=new app.router,this.basePath=this.config.BASE_PATH+this.lang,Backbone.history.start({pushState:!0,root:this.basePath})},app.showView=function(e){this.currentView&&this.currentView.close(),this.currentView=e,this.$main.html(this.currentView.el),app.scrollTop()},app.events={},_.extend(app.events,Backbone.Events),app.events.on("menu",function(){}),app.scrollTop=function(){var e=$("html, body");e.animate({scrollTop:0},"500","swing",function(){})},app.scrollToEl=function(e){$("html, body").animate({scrollTop:e.offset().top},500)},app.nl2br=function(e,t){var n=t||"undefined"==typeof t?"<br />":"<br>";return(e+"").replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1"+n+"$2")},app.dateFormat=function(e){var t=new Date(e),n=t.getMonth()+1,i=t.getUTCDate(),o=t.getFullYear();return 10>i&&(i="0"+i),10>n&&(n="0"+n),i+"/"+n+"/"+o},app.dateTimeFormat=function(e){var t=new Date(e),n=t.getMonth()+1,i=t.getUTCDate(),o=t.getFullYear(),a=t.getHours(),p=t.getMinutes();return 10>n&&(n="0"+n),10>i&&(i="0"+i),10>a&&(a="0"+a),10>p&&(p="0"+p),i+"/"+n+"/"+o+" - "+a+":"+p},app.urlify=function(e,t){if(!e)return"";var n=/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/i;return e.replace(n,"<a href='$1' "+t+">$1</a>")},app.loadingHTML=function(){return"<div class='container'><div class='row'><div class='grid-md-10 col-md-offset-2'><div class='loading'>Loading</div></div></div></div>"},app.renameID=function(e,t,n){for(var i=0;i<e.length;i++)e[i][n]=e[i][t],delete e[i][t];return e};